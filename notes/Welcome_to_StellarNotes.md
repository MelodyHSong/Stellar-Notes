...
- ☆ **Star & Pin Notes**: Keep your highest-priority transmissions pinned to the top of your console.
...
| `Ctrl + F` | Jump to cosmic search bar |
| `Ctrl + P` | Pin / unpin current note |
| `Ctrl + D` | Delete current note |
| `Ctrl + Space` | Read aloud / stop voice narration |
