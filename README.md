...
- ☆ **Spaceship Hull Console Aesthetic**:
  - **Catalog Sidebar**: Deep obsidian console (`#11141c`) with celestial amber stars (`#f2cc60`) and starlight cyan badges (`#58a6ff`).
...
- [CHANGELOG.md](CHANGELOG.md) — Review version history and release notes.
- [CONTRIBUTING.md](CONTRIBUTING.md) — Environment setup, test workflow, and PR guidelines.
- [LICENSE](LICENSE) — Full MIT License terms.

---

## ☆ License

This project is licensed under the [MIT License](LICENSE). You are free to use, modify, and distribute this code in your own projects— just keep the headers intact!

---

*Keep your thoughts amongst the stars— MelodyHSong (Cassiopeia Studios)*
